...
@section('title', 'Tambah Jurusan - SMKN 4 Bogor')
    ...
    <main class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-lg p-6 md:p-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-6 text-center">Tambah Jurusan</h1>
                ...
                <form action="{{ route('admin.jurusan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="icon" name="icon" value="{{ old('icon', 'fas fa-graduation-cap') }}" required
                    ...
                    <div class="mt-6">
                        ...
                        <div id="competencies-container">
                            <div class="flex items-center space-x-2 mb-2">
                                <input type="text" name="competencies[]" value="{{ old('competencies.0') }}" required
                    ...
                    <div class="mt-6">
                        ...
                        <div id="careers-container">
                            <div class="flex items-center space-x-2 mb-2">
                                <input type="text" name="careers[]" value="{{ old('careers.0') }}" required
                                    class="flex-1 px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
