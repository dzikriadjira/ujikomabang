            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-2">Perbarui konten berita yang ada</p>
                    </div>
                            ...
                            <div>
                                ...
                                <div class="image-preview-container rounded-lg p-6 text-center">
                                    ...
                                    <div id="imagePreview" class="mb-4">
                                        @if($berita->image)
                                            <img src="{{ asset('images/' . $berita->image) }}" alt="Current image" class="w-full h-48 object-cover rounded-lg mb-4">
                                            <p class="text-green-600 text-sm mb-2">
                                                <i class="fas fa-check-circle mr-1"></i>Gambar saat ini
                                            </p>
                                            <button type="button" 
                                                    onclick="document.getElementById('image').click()"
                                                    class="px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition text-sm">
                                                <i class="fas fa-exchange-alt mr-2"></i>Ganti Gambar
                                            </button>
                                        @else
                                            ...
                                            <button type="button" 
                                                    onclick="document.getElementById('image').click()"
                                                    class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition mt-2">
