...
@section('title', 'Tambah Prestasi - SMKN 4 Bogor')
    ...
    <main class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-lg p-6 md:p-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-6 text-center">Tambah Prestasi</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="category" name="category" required
                                ...
                                <option value="pencapaian" {{ old('category') == 'pencapaian' ? 'selected' : '' }}>Pencapaian</option>
                        ...
                        <div>
                            ...
                            <input type="text" id="year" name="year" value="{{ old('year', date('Y')) }}" required
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="achievement_details" name="achievement_details" rows="3"
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 @error('achievement_details') border-red-500 @enderror">{{ old('achievement_details') }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="text" id="icon" name="icon" value="{{ old('icon', 'fas fa-trophy') }}" required
