        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden lg:flex items-center space-x-2">
                    <a href="{{ route('dashboard') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-150">
                        <i class="fas fa-tachometer-alt w-4 h-4 mr-2 icon-blue"></i>
                        <span>Dashboard</span>
                    </a>
                    <a href="{{ route('gallery.index') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-150">
                        <i class="fas fa-images w-4 h-4 mr-2 icon-blue"></i>
                        <span>Galeri</span>
                    </a>
                    @if(auth()->user()->isAdmin())
                    <a href="{{ route('admin.jurusan.index') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-150">
                        <i class="fas fa-graduation-cap w-4 h-4 mr-2 icon-blue"></i>
                        <span>Jurusan</span>
                    </a>
                    <a href="{{ route('admin.fasilitas.index') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-150">
                        <i class="fas fa-building w-4 h-4 mr-2 icon-blue"></i>
                        <span>Fasilitas</span>
                    </a>
                    <a href="{{ route('admin.prestasi.index') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-150">
                        <i class="fas fa-trophy w-4 h-4 mr-2 icon-blue"></i>
                        <span>Prestasi</span>
                    </a>
                    <a href="{{ route('categories.index') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-150">
                        <i class="fas fa-tags w-4 h-4 mr-2 icon-blue"></i>
                        <span>Kategori</span>
                    </a>
                    <a href="{{ route('register') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-150">
                        <i class="fas fa-user-plus w-4 h-4 mr-2 icon-blue"></i>
                ...
                <div class="flex items-center space-x-2">
                    <div class="hidden md:flex items-center space-x-2">
                        <div x-data="{ open: false }" class="relative">
                            <button @click="open = !open" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all duration-150 focus:outline-none">
                            ...
                            <div x-show="open" 
                                ...
                                <div class="py-1">
                                    <a href="{{ route('profile.show') }}" class="text-gray-700 block px-4 py-2 text-sm hover:bg-gray-100">
                                        <i class="fas fa-user-circle mr-2 text-blue-500 w-4"></i>
                                        Profil Saya
                                    </a>
                                    @if(auth()->user()->role === 'admin')
                                    <a href="{{ route('admin.users.index') }}" class="text-gray-700 block px-4 py-2 text-sm hover:bg-gray-100">
                                        <i class="fas fa-users-cog mr-2 text-purple-500 w-4"></i>
                                        Kelola Pengguna
                                    </a>
                                    @endif
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit" class="w-full text-left text-red-600 block px-4 py-2 text-sm hover:bg-red-50">
                    ...
                    <!-- Mobile menu button -->
                    <div class="lg:hidden">
                        <button type="button" class="mobile-menu-button inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition-all duration-150" aria-controls="mobile-menu" aria-expanded="false">
            ...
            <!-- Mobile menu -->
            <div class="lg:hidden mobile-menu hidden" id="mobile-menu">
                <div class="px-3 pt-2 pb-3 space-y-1 bg-gray-50 rounded-md mt-2 border border-gray-200">
                    <!-- User Info -->
                    ...
                    <div class="pt-2">
                        <a href="{{ route('dashboard') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-all duration-150">
                            <i class="fas fa-tachometer-alt w-4 h-4 mr-2 text-blue-500"></i>
                            Dashboard
                        </a>
                        <a href="{{ route('gallery.index') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-all duration-150">
                            <i class="fas fa-images w-4 h-4 mr-2 text-blue-500"></i>
                            Galeri
                        </a>
                        <a href="{{ route('profile.show') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-all duration-150">
                            <i class="fas fa-user-circle w-4 h-4 mr-2 text-blue-500"></i>
                            Profil Saya
                        </a>
                    @if(auth()->user()->isAdmin())
                    <a href="{{ route('admin.jurusan.index') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-all duration-150">
                        <i class="fas fa-graduation-cap w-4 h-4 mr-2 text-blue-500"></i>
                        Jurusan
                    </a>
                    <a href="{{ route('admin.fasilitas.index') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-all duration-150">
                        <i class="fas fa-building w-4 h-4 mr-2 text-blue-500"></i>
                        Fasilitas
                    </a>
                    <a href="{{ route('admin.prestasi.index') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-all duration-150">
                        <i class="fas fa-trophy w-4 h-4 mr-2 text-blue-500"></i>
                        Prestasi
                    </a>
                    <a href="{{ route('categories.index') }}" class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-all duration-150">
                        <i class="fas fa-tags w-4 h-4 mr-2 text-blue-500"></i>
                        Kategori
                    </a>
