...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-600">Buat kategori baru untuk galeri</p>
    </div>
        ...
        <form id="categoryForm" class="p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500" required>
                    <p data-error="name" class="text-sm text-red-600 mt-1 hidden"></p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Deskripsi</label>
                    <textarea name="description" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"></textarea>
                    <p data-error="description" class="text-sm text-red-600 mt-1 hidden"></p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Warna</label>
                    <input type="color" name="color" value="#3B82F6" class="w-16 h-10 p-0 border border-gray-300 rounded-md">
